...
const { version, isLatest } = await fetchLatestBaileysVersion()
    console.log(chalk.red.bold('\n\n\n\n\n\n╭╮\n┃╭╮━┃╰╮╭╯┃\n╮╰╯╭╯\n╱╱╰╮╭╯╱\n╱╱┃┃╱╱\n╱╱╱\n\nERROR-X.2 Version 2.0.0\n\nCreated By : ËMMÝHĚÑŽ Developer\nTelegram : t.me/EmmyHenz\nSubscribe Youtube : @EMMYHENZTECHINFO\nCREDITS : REJEONG, 𝐙𝐲𝐧𝐓𝐳𝐲 and EMMYHENZ'))
...
rejeong.sendMessage(`120363317747980810@s.whatsapp.net`, { text: `\`𝗛𝗶 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿\`
  ERROR-X.2 CONNECTED SUCCESSFULLY☠, contact +2349125042727 if you need any help`})
if (autoJoin) {
